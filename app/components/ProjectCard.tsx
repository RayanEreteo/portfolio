...
function ProjectCard({ title, description, completed, gitHubLink, projectLink }: ProjectCardProps) {
  return (
    <div className="project-card flex items-center justify-between flex-col p-4 border border-gray-300 rounded-lg shadow-md m-4">
     ...
     { completed ?  <a href={projectLink} className="project-status text-blue-500 mb-3" target="_blank">{projectLink ? "✅ Terminé : Accéder au projet..." : "✅ Terminé"}</a> : <span className="text-yellow-500 font-bold mb-3">En cours de développement</span> }
