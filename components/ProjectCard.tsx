...
interface projectI {
  projectName: string,
  projectDesc: string,
  projectThumbnail: "portfolio.png" | "extension.png" | "socialtree.png"
  projectLink: string,
  inDev?: boolean
  moveLeft: () => void,
  moveRight: () => void
...
function ProjectCard({ projectName, projectDesc, projectThumbnail, projectLink, moveLeft, moveRight, inDev }: projectI) {
  return (
    <div className={`project-card h-[100%] w-[100%] flex justify-around items-center`}>
      ...
      <div className="text-content text-center">
        ...
        <br />
        <a className={`mt-11 ${inDev ? "bg-black pointer-events-none" : "bg-red-600"} p-3 rounded`} href={projectLink} target="_blank">{inDev ? "Projet en développement" : "Visiter le projet"}</a>
      </div>
