...
function Projects() {
  ...
  return (
    <div id="projects-container" className={`text-[#FBE2E2] w-[400vw] border-2 flex flex-row border-white mt-[5rem] mb-[5rem] h-[80vh] transition-all`} style={{ transform: `translateX(-${pos}vw)` }}>
      ...
      <ProjectCard cancelled moveLeft={moveLeft} moveRight={moveRight} projectThumbnail={"socialtree.png"} projectName={"Social Tree"} projectLink="https://github.com/RayanEreteo/socialtree" projectDesc="Créer une carte personnalisée ou vous pouvez afficher vos reseaux sociaux."></ProjectCard>
